...
public abstract class V1SchemeSigner {
    ...
    public static OutputManifestFile generateManifestFile(
        ...
        for (String entryName : sortedEntryNames) {
            ...
            entryAttrs.putValue(
                    entryDigestAttributeName,android.util.Base64.encodeToString(entryDigest, android.util.Base64.DEFAULT));
    ...
    private static byte[] generateSignatureFile(
        ...
        mainAttrs.putValue(
                getManifestDigestAttributeName(manifestDigestAlgorithm),android.util.Base64.encodeToString(md.digest(manifest.contents), android.util.Base64.DEFAULT));
        ...
        for (Map.Entry<String, byte[]> manifestSection
            ...
            attrs.putValue(
                    ...
                    android.util.Base64.encodeToString(sectionDigest, Base64.DEFAULT));
